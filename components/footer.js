  ...
  return (
    <footer className=" px-10 mt-40 py-10 bg-[#CF8B35] text-white">
      ...
      >
        ...
        Jl. Srikandi No.22, Ngabean Kulon, Sinduharjo, Ngaglik, Sleman Regency,
        Special Region of Yogyakarta 55581
      </a>
      <iframe
        ...
        allowFullScreen=""
        loading="lazy"
        referrerPolicy="no-referrer-when-downgrade" // Corrected spelling
